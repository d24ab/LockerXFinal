            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        booking.setStartTime(LocalTime.parse(dataSnapshot.child("startTime").getValue().toString(), timeFormatter));
                        booking.setEndTime(LocalTime.parse(dataSnapshot.child("endTime").getValue().toString(), timeFormatter));
                ...
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        if (booking.getMobile().equals(ds.getMobile())) {
                            Log.d(TAG, "onDataChange: RBOOKINGSFORUSER " +booking.getStartDate().toString());
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        booking.setStatus(dataSnapshot.child("status").getValue().toString().charAt(0));
                        if (booking.getMobile().equals(ds.getMobile())) {
                            Log.d(TAG, "onDataChange: CBOOKINGSFORUSER " +booking.getStartDate().toString());
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        booking.setStatus(dataSnapshot.child("status").getValue().toString().charAt(0));
                        if (booking.getMobile().equals(ds.getMobile())) {
                            Log.d(TAG, "onDataChange: BBOOKINGSFORUSER " +booking.getStartDate().toString());
