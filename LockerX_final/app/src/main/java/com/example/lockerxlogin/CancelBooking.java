...
//        if (strs.length()==16) {
//            sdateTime = LocalDateTime.parse(strs, formatter);
//        }
//        else {
            sdateTime = LocalDateTime.parse(strs, formatterSeconds);
//        }
//        if (stre.length()==16) {
//            edateTime = LocalDateTime.parse(stre, formatter);
//        }
//        else {
            edateTime = LocalDateTime.parse(stre, formatterSeconds);
//        }
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog,
                        ...
                        dc.setBookingStatus(mobile,Long.parseLong(structureid),Long.parseLong(lockerid),
                                LocalDate.parse(startDate),LocalTime.parse(startTime, timeFormatter),
                                LocalDate.parse(endDate),LocalTime.parse(endTime, timeFormatter),'C');
                        Toast.makeText(getApplicationContext(),"Yes is clicked",Toast.LENGTH_LONG).show();

                        Intent intent = new Intent(CancelBooking.this, MainFunc.class);
